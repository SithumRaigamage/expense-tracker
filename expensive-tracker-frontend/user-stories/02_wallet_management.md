...
### 3. Wallet Archiving
- **Story**: As a user, I want to archive old wallets (e.g., a closed bank account) so they don't clutter my active list, while still preserving their historical transaction data.
- **Benefit**: Cleaner UI while maintaining full historical records.

### 4. Asset Appreciation/Depreciation
- **Story**: As a user tracking investments, I want to manually update the "Current Value" of an asset wallet (like Crypto or Stocks) and have the system record the gain/loss automatically.
- **Benefit**: Simplifies wealth tracking for volatile assets.
